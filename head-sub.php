        ...
        <ul>
          <li class="depth1">
            ...
            <ul class="depth2">
              ...
              <li><a href="/sub/sub1-3.php">매장</a></li>
          ...
          <li class="depth1">
              ...
              <ul class="depth2">
                <li><a href="/sub/sub2-1.php">부대찌개</a></li>
                <li><a href="/sub/sub2-2.php">떡볶이</a></li>
              </ul>
          </li>
          <li class="depth1">
          ...
          <li class="depth1">
            <a href="/sub/sub4-1.php">땅스소식</a>
            <ul class="depth2">
              <li><a href="/sub/sub4-1.php">소식</a></li>
              <li><a href="/sub/sub4-2.php">이벤트</a></li>
              <li><a href="/sub/sub4-3.php">특별이벤트</a></li>
              <li><a href="/sub/sub4-4.php">SNS</a></li>
            </ul>
          </li>
          <li class="depth1">
            ...
            <ul class="depth2">
              ...
              <li><a href="/sub/sub5-3.php">개설 Q&A</a></li>
            </ul>
          </li>
        </ul>
      </nav>
        ...
        <div class="mobile-wrap">
          ...
          <div class="mobile-gnb">
            <ul>
              ...
              <li class="mobile-depth1">
                <a href="/sub/sub2-1.php">메뉴<i class="xi-angle-down-min"></i></a>
                <ul class="mobile-depth2">
                  <li><a href="/sub/sub2-1.php">부대찌개</a></li>
                  <li><a href="/sub/sub2-2.php">떡볶이</a></li>
                </ul>
              ...
              <li class="mobile-depth1">
                <a href="/sub/sub4-1.php">땅스소식<i class="xi-angle-down-min"></i></a>
                <ul class="mobile-depth2">
                  <li><a href="/sub/sub4-1.php">소식</a></li>
                  <li><a href="/sub/sub4-2.php">이벤트</a></li>
                  <li><a href="/sub/sub4-3.php">특별이벤트</a></li>
