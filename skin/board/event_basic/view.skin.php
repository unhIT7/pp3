...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        ...
        <h5>이벤트기간 : <?php echo $view['wr_1'] ?> ~ <?php echo $view['wr_2'] ?></h5>
        <h2 id="bo_v_title">
            <span class="bo_v_tit">
                <?php
    ...
    <section id="bo_v_info">
        ...
        <div id="bo_v_top">
            ...
            <ul class="btn_bo_user bo_v_com">
	            ...
	            <?php if ($reply_href) { ?>
                <li class="pc_view">
                    <a href="<?php echo $reply_href ?>" class="btn_b01 btn" title="답변"><i class="fa fa-reply" aria-hidden="true"></i><span class="sound_only">답변</span></a>
                </li>
                <?php } ?>
                -->
                ...
                <?php if ($write_href) { ?>
                <li class="pc_view">
                    <a href="<?php echo $write_href ?>" class="btn_b01 btn" title="작성"><i class="fa fa-pencil" aria-hidden="true"></i><span class="sound_only">작성</span></a>
                </li>
                <?php } ?>
