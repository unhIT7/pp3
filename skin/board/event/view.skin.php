...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info" class="topbt">
        <span class="sound_only">이벤트 설명</span> <span class="subtxt"><?php echo $view['wr_8'] ?></span><br>
        <span class="sound_only">이벤트 기간</span> <span class="subtxt"><?php echo $view['wr_9']." ~ ".$view['wr_10'] ?></span>
    </section>
